...
- Helm 3.x (chart templates), Python 3.10+ (Dagster, dbt), YAML (Kubernetes manifests) (008-kubernetes-demo)
- MinIO (S3-compatible) for Iceberg Parquet files, PostgreSQL for metadata (008-kubernetes-demo)
...
## Recent Changes
- 008-kubernetes-demo: Added Helm 3.x (chart templates), Python 3.10+ (Dagster, dbt), YAML (Kubernetes manifests)
