...
# ==============================================================================
# Write Trino Iceberg connector configuration with OAuth2 credentials
# This file is mounted into Trino's catalog directory
# ==============================================================================
TRINO_ICEBERG_CONFIG="/config/trino-iceberg.properties"
echo "Writing Trino Iceberg config to ${TRINO_ICEBERG_CONFIG}..."

cat > "${TRINO_ICEBERG_CONFIG}" << EOF
# Trino Iceberg Connector - Auto-generated by polaris-init
# DO NOT EDIT - regenerated on each docker compose up
#
# This file contains OAuth2 credentials for Polaris authentication.
# The credentials are dynamically extracted from Polaris logs on startup.
...
echo "Trino Iceberg config written to ${TRINO_ICEBERG_CONFIG}"
