...
are automatically loaded and executable in Dagster using real infrastructure.

This test validates the end-to-end flow of declarative orchestration
without using inline asset definitions - all assets should come from
real modules or Docker services.
"""
...
class TestDeclarativeOrchestration(IntegrationTestBase):
    """Integration tests for declarative orchestration auto-loading."""

    @pytest.mark.integration
    @pytest.mark.requirement("010-FR-018", "010-FR-024", "010-FR-025")
    def test_declarative_job_schedule_execution(self) -> None:
    ...
    def test_partitions_from_config_available_to_jobs(self) -> None:
    ...
    def test_multiple_jobs_with_different_selections(self) -> None:
    ...
    def test_schedule_with_partition_selector(self) -> None:
    ...
    def test_graceful_degradation_on_invalid_config(self) -> None:
    ...
    def test_schedule_references_valid_job(self) -> None:
